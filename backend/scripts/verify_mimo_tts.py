...
def test_mimo_tts():
    ...
    # 测试音色列表：苏打（男声）和 茉莉（女声）
    voices = [
        {"name": "苏打", "style": "用温暖、活泼、略带幽默的语气说话，语速偏快", "text": "大家好，欢迎收听今天的播客节目！今天我们来聊聊一个非常有趣的话题。"},
        {"name": "茉莉", "style": "用专业、清晰、语速适中偏快的语气说话，节奏明快", "text": "好的，让我来为大家详细介绍一下这个领域的最新进展。"},
    ]
